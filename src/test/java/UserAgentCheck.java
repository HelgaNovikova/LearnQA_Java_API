...
public class UserAgentCheck {
    ...
    public void testUserAgent(String userAgent, String expectedPlatform, String expectedBrowser, String expectedDevice) {
        JsonPath getUserAgentData = RestAssured
                ...
                .jsonPath();
        assertAll("request check", () -> assertEquals(expectedPlatform, getUserAgentData.get("platform")),
                () -> assertEquals(expectedBrowser, getUserAgentData.get("browser")),
                () -> assertEquals(expectedDevice, getUserAgentData.get("device")));
    }
